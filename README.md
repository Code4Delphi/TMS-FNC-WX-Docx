# Word com Delphi: geração de arquivos .DOCX - TMSFNCWXDocx

Exemplo prático de geração de documentos do Word no formato `.DOCX` utilizando Delphi. O projeto demonstra como criar, preencher e salvar arquivos de maneira rápida e simples.
